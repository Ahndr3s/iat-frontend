    ...
    <>
      ...
      <div className="text-info mt-6">
        <p className="p-info mx-8">
          ...
          , reinventamos el camino hacia la excelencia educativa. Como pioneros
          en el coaching educativo, nuestra misión trasciende la enseñanza
          tradicional; nos dedicamos a encender la chispa del crecimiento tanto
          académico como personal en maestros y estudiantes por igual.
        </p>
      </div>

      <div className="team-container" id="team-container">
        <h3 className="subtitle mt-6 ml-6 md:ml-64 lg:ml-64">Nuestro equipo</h3>
        <p className="txt-team mb-1 text-2xl text-justify pb-4">
          Estamos encantados de presentar a nuestro equipo de profesionales
          dedicados a redefinir su experiencia en educacion
        </p>
      </div>
      <div className="card-container text-2xl grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2">
