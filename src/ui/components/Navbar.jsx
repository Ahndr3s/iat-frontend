...
export const Navbar = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 h-[8vh] w-full bg-[var(--bg-primary)] z-[1000] flex items-center justify-between px-6 box-border transition-all duration-300">
      <ul className="flex flex-row items-center list-none m-0 p-0 flex-1 h-full">
        ...
        <div
          ...
          bg-[var(--bg-primary)] md:bg-transparent z-[1000] overflow-y-auto md:overflow-visible
          transition-all duration-300 ease-in-out box-border
          ${showNavbar ? "w-[270px] p-6 border-r border-gray-800 md:border-0" : "w-0 md:w-auto overflow-hidden md:overflow-visible"}
